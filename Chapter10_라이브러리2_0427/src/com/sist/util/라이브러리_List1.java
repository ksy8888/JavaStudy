...
/*
 	335 page => Collection => 데이터를 묶어서 관리할 수 있게 만든 클래스
 				=> 배열의 단점 보완
 				
 	컬렉션 프레임워크 (프레임워크 => 표준화)
 		 ------> 모든 개발자가 동일한 형태로 소스코딩
 		 		 소스의 통일화 목적 : Sprint , MyBatis, JQuery, VueJS , ReactJS
...
---------------------------------------------------------------
  	...
  	==> Map (웹에서 지원하는 모든 클래스는 Map형식을 가지고 있다)
  			 request , response , session , cookie	 	//키,value구성
...
---------------------------------------------------------------
  		...
  		프로젝트)
  			...
  			2차: Sprint / String 라이브러리 / VueJS
  			3차: 최신 기술: Spring-Boot / ReactJS(Redux)
...
/*
 	...
 	ArrayList list = new ArrayList();  ==> 10개를 넘으면 자동 10개 추가...
 	
 	ArrayList list = new ArrayList(10)
 */
public class 라이브러리_List1 {
	...
	public static void main(String[] args) {
		...
		list.add("심청이");	//index=2	//2번 충돌. 	//index=3이됨		//3번 충돌.	//index=4
		list.add("춘향이");	//index=3				//index=4					//index=5
		list.add("이순신");	//index=4				//index=5					//index=6
...
/*
 * ArrayList는 중간에 생략하는 번호가 없이 순차적으로 자동 설정이 된다
0.홍길동
1.박문수
2.강감찬
//3.을지문덕 **** 삭제
...
5.이순신
6.박문수
========> 이름으로 삭제 요청 => 가장 처음에 있는 이름만 삭제 
*/		//삭제
		System.out.println("======== 삭제 ========");
		//삭제 =>list.remove(index) , 	list.remove("홍길동")
		//실제값을 삭제 => 중복이 있는 경우 전부 삭제
	//	list.remove("박문수");	//중복된 값 삭제시 가장 위의값을 삭제함
		list.remove(3);
		for(int i=0; i<list.size(); i++) {
			System.out.println(i+"."+list.get(i));
		}
