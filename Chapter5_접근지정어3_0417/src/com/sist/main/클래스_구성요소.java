 		...
 		class ClassName
 		{
 			...
 			3) 변수 사용 방법
 				...
 				정적 변수
 					...
 					메모리 할당을 안해도 된다 >> new 안써도됨
 					=> A.a (클래스명으로 접근가능) => 클래스변수, 공유변수
 			*** 보안 중심
 			...
 			*** 멤버변수는 사용이 가능한 옵션 : static, final(상수)
 			...
 			생성자
 			  = 특징
 			  	...
 			  	3) 오버로딩 (중복 메소드) => 생성자는 필요시에 여러개를 만들 수 있다
 			  		...
 			  		*** 초기화
 			  		...
 			  		2) 초기화 블록: 멤버변수, static 변수 초기화가 가능
 			  			...
 			  			class A
 			  			{
 			  				...
 			  				{
 			  				for(int i=0; i<10; i++)	==> 오류. class 안에서 구현불가능. 하고 싶으면 초기화 블록 안에 구현문을 넣어야함
	 			  			{
	 			  				a=i;
	 			  			}
 			  				}
 			  		...
 			  		4) 생성자 : 멤버변수, static 변수 초기화가 가능	==> 가장 많이 사용된다
 			  			=> this 사용이 가능
 			  			class A
 			  			{
 			  				int a;
 			  			...
 			  			*** static 변수는 생성자보다 static 블록을 많이 사용
 			  			*** 생성자는 필요시마다 호출
 			  				초기화 블록은 자동 호출
 			  순서
 			...
 			메소드 : 다른 클래스와 연결 담당(메세지)
 				...
 				----> 한개만 사용이 가능 (결과값이 많은 경우 => 클래스, 배열 이용)
...
class B
{
	...
	void display(int a) {
		...
		this.a=a; 	//밖에 있는 a 사용시, 앞에 this. 붙여줌
	}
}
//=====================================================================
//class C
...
//		System.out.println(a);
//		this.a=a; 	//a=20;
//		System.out.println(super.a); //C클래스, 최상단 변수 a=10;
//	}
//}
//==================================================================
class C
