...
/*
 		*** 예외를 수정하는 것이 아니다 => 에러발생한 소스를 건너뛴다
 		...
 		---
 			...
 			문장5
 			문장6			
 			==========> 문장1 => 문장2 => 문장3 => 문장5 => 문장6 (에러없을때)
 			
 			try {
 				문장1
 				문장2		==> 에러발생 ==> catch로 이동
 				문장3
 				try안에서 에러발생시에 에러난 위치부터 try 끝까지는 수행하지 않는다
 				------------------------------------------------
...
public class 예외처리_예외복구_2 {
	...
	/*	System.out.println("문장1");
		...
		try {
			...
			System.out.println("문장6");		//수행X >> catch로 이동
			
		} catch(ArrayIndexOutOfBoundsException e) {		//에러처리시 => 0으로 나눌 경우만 처리가능
			System.out.println("문장6; 에러처리완료");
