...
public class 라이브러리_Object_finalize {
	...
	public static void main(String[] args) {
		...
		// 객체 메모리 해제 (메모리에서 삭제)	=> 자동 호출됨
		s=null; //GC대상
		//메모리를 해제 => 강제로 명령
		System.gc();	//null값 주고 gc호출로 메모리 해제. >> finalize메소드 활용
	}
