...
public class 입출력_6 {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.load(new FileInputStream("C:\\javaDev\\javaStudy\\Chapter11_입출력_IO1_0503\\src\\com\\sist\\io\\db.properties"));
		...
		prop4.load(new FileInputStream("C:\\javaDev\\javaStudy\\Chapter11_입출력_IO1_0503\\info.properties"));
