...
public class 라이브러리_lang정리 {
	...
	public static void main(String[] args) {
		...
		list.add("aaa");
		String a = (String)list.get(0);	//list가 Object형이기 때문에 String형변환 시켜줌
		
	//	list.add(1);
	//	int b = (int)list.get(1);
		//Integer i=10(클래스에는 주소만 들어가는데, 실제값을 넣어줄 때를 오토박싱) ==   int ii=i(기본형에 클래스형 데이터(객체) 받는 것을 언박싱)
		
		
		//int aa = new Integer(10);	//언박싱
