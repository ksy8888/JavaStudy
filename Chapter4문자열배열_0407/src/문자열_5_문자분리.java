 ...
 */
public class 문자열_5_문자분리 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String[] music = {"Kitsch","CHRISTIAN","꽃","Ditto","Hype boy","Teddy Bear","사건의 지평선","OMG","심 (心)","I Dont Think That I Like Her",
	...
	/*	String s= "Hello Java!!";
		...
		String s1 = s.substring(6); //6번 문자부터 자름
		System.out.println(s1);	//Java!!
		
		String s2 = s.substring(0,5);  //0부터 5번의 전까지 자름
		...
		//String s ="That That (Prod. & Feat. SUGA of BTS)";
		//System.out.println(s.length());
		
	/*	for(String s :music) {
			if(s.length() > 37) {	//글자수가 37자 이사이면 이후글자 ...으로 출력
	...
	*/	
		String addr = "서울특별시 마포구 어울마당로 146-1"
				+ "지번 서울시 마포구 서교동 331-1";
		
		String a  = addr.substring(0, addr.lastIndexOf("지")); // lastIndexOf("찾고싶은 인덱스") >> 글자의 위치값을 찾아줌
		System.out.println(a);
		
		String a2  = addr.substring(addr.lastIndexOf("서울")); 	//lastindex 써서 뒤쪽 서울부터~자름
		...
		// 앞쪽 a 찾으려면 indexOf 사용(앞에서부터 찾기), 뒷쪽 a 찾으려면 lastIndexOf 사용(뒤에서부터 찾기)
	
		
////////////////////////////////////////////////////////////////////////////////////////
		String str = "Hello Java";
		String sss =str.replace("a", "b");	///a를 b로 바꿈
