...
/*
  	...
  	---------------------
  		Container: 윈도우
  		  ...
  		  JDialog: 정보창, 입력창
  		  JWindow: 사용빈도가 거의 없다
  		  JPanel: 독립적으로 사용 불가능 => JFrame 위에 설정
...
public class MainClass_1 extends JFrame {
	...
	public MainClass_1() {
		...
		//일자로 배치
		JPanel p = new JPanel();
		p.setLayout(new GridLayout(1,5,5,5)); //(row,col, 좌우,상하간격)
		p.add(b1);
		p.add(b2);
		p.add(b3);
		p.add(b4);
	...
	public static void main(String[] args) {
		//생성자만 호출
		try {
			//UIManager.setLookAndFeel("com.jtattoo.plaf.hifi.HiFiLookAndFeel"); //검은색
			//UIManager.setLookAndFeel("com.jtattoo.plaf.mcwin.McWinLookAndFeel"); //맥 흰색
